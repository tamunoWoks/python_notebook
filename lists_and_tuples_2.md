...
value. When you assign the forst variable a new value, you’ve changed its name tag references.  
&nbsp;&nbsp;&nbsp;&nbsp;The change doesn’t affect the second variable, which still refers to the initial value.
